...
if (!admin.apps.length) {
  // Prefer environment variables in production; fallback to local JSON in development
  let serviceAccount = null;
  try {
    if (process.env.FIREBASE_SERVICE_ACCOUNT) {
      // Entire service account JSON as a single env var
    ...
    // If local file is missing during build, surface a clear error
